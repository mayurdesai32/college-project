...
console.log("Nitrogen",Nitrogen)
 ...
 if (
      ...
      return  console.log('Please fill all the detail')
    }
    
    else {
      navigation.navigate('CropResult',{"Nitrogen": Nitrogen,
...
marginLeft:"auto",
      marginBottom:responsiveHeight(3.3),
             marginTop: responsiveHeight(3), 
                 ...
                 textAlign:"center"   ,        
                 fontWeight:'800'}}> Find out the most suitable Crop to grow in your farm</Text>
...
style={{width:"100%",alignContent:'center',}}>
 ...
 onChangeText={setNitrogen}
  ...
  <Text style={{    fontSize: responsiveFontSize(2.9),
    marginBottom: responsiveHeight(-1),
    color: 'black',
    fontWeight: '700',}}>Select state</Text>
...
<DropDownComponent  
  ...
  <TouchableOpacity style={defaultStyles.btn} activeOpacity={0.7} onPress={()=>{croprecomFun()}}>
        <Text style={{color:colors.color2,fontSize:responsiveFontSize(3) ,   
            textAlign:"center",
            fontWeight:'600'}}>Predicte Crop</Text>
    </TouchableOpacity>
